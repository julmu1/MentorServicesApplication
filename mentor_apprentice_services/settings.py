"""
Django settings for mentor_apprentice_services project.
...
ALLOWED_HOSTS = ['mentorservicesapplication-3.onrender.com', 'localhost']
...
ROOT_URLCONF = 'mentor_apprentice_services.urls'
